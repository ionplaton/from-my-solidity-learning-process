...
/*
I will create a CrowdFunding contract with the following details:
- The Admin will start a compaign for **CrowdFunding** with a specific monetary goal and deadline.
...
- If more than 50% of the total contributors voted for that request, then the admin would have the permisssion to spend the amunt specified in the spending request.
- The power is moved from the campaingn's admin to those that donated money.
