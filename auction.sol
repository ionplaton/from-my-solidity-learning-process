...
/*
I will write a smart contract for a Decentralized Auction (like eBay).
- The Auction has an owner (the seller of good or service), a start and an end date.
...
- Users are incentivized to bid the maximum they are willing to pay, but they are not bound
  to that full amount, but rather to the previous highest bid plus an incerement.
  The contract will automatically bid up to a given amount.
- The highestBindingBid is the selling price and the gighestbidder the person who won the auction.
...
contract Auction{
    ...
    constructor(){
        ...
        endBlock = startBlock + 40320; // one week consist of 40320 seconds
